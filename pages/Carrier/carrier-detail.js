...
const detail = () => {
  ...
  return (
    ...
    <img className="img-fluid banner_img" src={detailphoto.src} alt="" />
...
<div _ngcontent-c14="" className="details_banner_twenty">
        ...
        <div _ngcontent-c14="" className="detail_holder_heading text-capiatlize">
        <h3 _ngcontent-c14="" className="heading2  ">Front End Development</h3>
        <div _ngcontent-c14="" className="carrier_card_twenty mt-4">
        <div _ngcontent-c14="" className="cip_holder">
        <img _ngcontent-c14="" className="career_icon_pic" src={badgeCard.src}/>
        
        </div>
        <p >#FrontEndDev #Angular #ReactJS #htmldeveloper #javascripts #bootstrap</p>
        </div><div _ngcontent-c14="" className="carrier_card_twenty mt-0">
        <div _ngcontent-c14="" className="cip_holder">
        <img _ngcontent-c14="" className="career_icon_pic" src={ndBadge.src}/>
        </div><p _ngcontent-c14="">Experience : 1 - 3 Years</p></div>
        <div _ngcontent-c14="" className="carrier_card_twenty mt-0">
        <div _ngcontent-c14="" className="cip_holder">
        <img _ngcontent-c14="" className="career_icon_pic" src={locationBadge.src}/>
        </div>
        <p _ngcontent-c14="">Location : Kolkata</p></div>
        <div _ngcontent-c14="" className="a_holder">
        <a _ngcontent-c14="" className="ripple-btn" >Apply Now</a>
